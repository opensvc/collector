table_uids_defaults = {
     ...
     'colprops': {'user_id': {'field': 'user_id', 'filter_redirect': '', 'force_filter': '', 'img': 'guy16', '_dataclass': '', 'title': 'User id', '_class': 'uid', 'table': 'v_uids', 'display': 1, 'default_filter': ''}, 'user_name': {'field': 'user_name', 'filter_redirect': '', 'force_filter': '', 'img': 'guy16', '_dataclass': '', 'title': 'User name', '_class': '', 'table': 'v_uids', 'display': 1, 'default_filter': ''}, 'user_id_count': {'field': 'user_id_count', 'filter_redirect': '', 'force_filter': '', 'img': 'guy16', '_dataclass': '', 'title': 'User count', '_class': '', 'table': 'v_uids', 'display': 1, 'default_filter': ''}},
...
table_gids_defaults = {
     ...
     'colprops': {'group_id': {'field': 'group_id', 'filter_redirect': '', 'force_filter': '', 'img': 'guys16', '_dataclass': '', 'title': 'Group id', '_class': 'gid', 'table': 'v_gids', 'display': 1, 'default_filter': ''}, 'group_id_count': {'field': 'group_id_count', 'filter_redirect': '', 'force_filter': '', 'img': 'guys16', '_dataclass': '', 'title': 'Group count', '_class': '', 'table': 'v_gids', 'display': 1, 'default_filter': ''}, 'group_name': {'field': 'group_name', 'filter_redirect': '', 'force_filter': '', 'img': 'guys16', '_dataclass': '', 'title': 'Group name', '_class': '', 'table': 'v_gids', 'display': 1, 'default_filter': ''}},
     'volatile_filters': false,
     'child_tables': [],
     'parent_tables': [],
     'dataable': false,
