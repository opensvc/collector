...
function table_comp_modulesets_services(divid, options) {
	var defaults = {
		...
		'columns': ['svc_id', 'svcname', 'encap', 'modset_id', 'modset_name', 'svc_status', 'svc_availstatus', 'svc_app', 'env', 'svc_ha', 'svc_cluster_type', 'svc_flex_min_nodes', 'svc_flex_max_nodes', 'svc_flex_cpu_low_threshold', 'svc_flex_cpu_high_threshold', 'svc_drptype', 'svc_containertype', 'svc_autostart', 'svc_nodes', 'svc_drpnode', 'svc_drpnodes', 'svc_comment', 'svc_created', 'svc_updated', 'svc_status_updated'],
...
function table_comp_status(divid, options) {
	var defaults = {
		...
		'columns': ['id', 'run_date', 'node_id', 'nodename', 'svc_id', 'svcname', 'run_module', 'run_status', 'run_status_log', 'rset_md5', 'run_log', 'assetname', 'fqdn', 'serial', 'model', 'asset_env', 'role', 'status', 'type', 'sec_zone', 'tz', 'loc_country', 'loc_zip', 'loc_city', 'loc_addr', 'loc_building', 'loc_floor', 'loc_room', 'loc_rack', 'enclosure', 'enclosureslot', 'hvvdc', 'hvpool', 'hv', 'os_name', 'os_release', 'os_vendor', 'os_arch', 'os_kernel', 'cpu_dies', 'cpu_cores', 'cpu_threads', 'cpu_model', 'cpu_freq', 'mem_banks', 'mem_slots', 'mem_bytes', 'listener_port', 'version', 'action_type', 'collector', 'connect_to', 'env', 'team_responsible', 'team_integ', 'team_support', 'app', 'last_boot', 'power_supply_nb', 'power_cabinet1', 'power_cabinet2', 'power_protect', 'power_protect_breaker', 'power_breaker1', 'power_breaker2', 'warranty_end', 'maintenance_end', 'os_obs_warn_date', 'os_obs_alert_date', 'hw_obs_warn_date', 'hw_obs_alert_date', 'updated'],
...
function table_prov_templates(divid, options) {
	var defaults = {
		...
		'columns': ['id', 'tpl_name', 'tpl_command', 'tpl_comment', 'tpl_created', 'tpl_author', 'tpl_team_responsible', 'tpl_team_publication'],
		'default_columns': ['tpl_name', 'tpl_command', 'tpl_comment', 'tpl_created', 'tpl_author', 'tpl_team_responsible', 'tpl_team_publication'],
		'wsable': true,
