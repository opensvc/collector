...
function table_checks(divid, options) {
	var defaults = {
		...
		'spankeys': ['node_id', 'chk_type'],
		'span': ['node_id'],
		'columns': ['node_id', 'nodename', 'svc_id', 'svcname', 'chk_type', 'chk_instance', 'chk_value', 'chk_low', 'chk_high', 'chk_err', 'chk_threshold_provider', 'chk_created', 'chk_updated', 'assetname', 'fqdn', 'serial', 'manufacturer', 'model', 'asset_env', 'role', 'status', 'type', 'sec_zone', 'tz', 'loc_country', 'loc_zip', 'loc_city', 'loc_addr', 'loc_building', 'loc_floor', 'loc_room', 'loc_rack', 'enclosure', 'enclosureslot', 'hvvdc', 'hvpool', 'hv', 'os_name', 'os_release', 'os_vendor', 'os_arch', 'os_kernel', 'cpu_dies', 'cpu_cores', 'cpu_threads', 'cpu_model', 'cpu_freq', 'mem_banks', 'mem_slots', 'mem_bytes', 'listener_port', 'version', 'action_type', 'collector', 'connect_to', 'node_env', 'team_responsible', 'team_integ', 'app_team_ops', 'team_support', 'app', 'app_domain', 'last_boot', 'last_comm', 'power_supply_nb', 'power_cabinet1', 'power_cabinet2', 'power_protect', 'power_protect_breaker', 'power_breaker1', 'power_breaker2', 'warranty_end', 'maintenance_end', 'os_obs_warn_date', 'os_obs_alert_date', 'hw_obs_warn_date', 'hw_obs_alert_date', 'updated'],
...
function table_comp_rulesets_nodes(divid, options) {
	var defaults = {
		...
		'span': ['node_id'],
		'spankeys': ['node_id'],
		'keys': ['node_id', 'ruleset_id'],
		'orderby': ['nodename', 'ruleset_name'],
		'force_cols': ['os_name', 'node_id', 'ruleset_id'],
		'columns': ['node_id', 'nodename', 'ruleset_id', 'ruleset_name', 'assetname', 'fqdn', 'serial', 'manufacturer', 'model', 'asset_env', 'role', 'status', 'type', 'sec_zone', 'tz', 'loc_country', 'loc_zip', 'loc_city', 'loc_addr', 'loc_building', 'loc_floor', 'loc_room', 'loc_rack', 'enclosure', 'enclosureslot', 'hvvdc', 'hvpool', 'hv', 'os_name', 'os_release', 'os_vendor', 'os_arch', 'os_kernel', 'cpu_dies', 'cpu_cores', 'cpu_threads', 'cpu_model', 'cpu_freq', 'mem_banks', 'mem_slots', 'mem_bytes', 'listener_port', 'version', 'action_type', 'collector', 'connect_to', 'node_env', 'team_responsible', 'team_integ', 'team_support', 'app', 'last_boot', 'last_comm', 'power_supply_nb', 'power_cabinet1', 'power_cabinet2', 'power_protect', 'power_protect_breaker', 'power_breaker1', 'power_breaker2', 'warranty_end', 'maintenance_end', 'os_obs_warn_date', 'os_obs_alert_date', 'hw_obs_warn_date', 'hw_obs_alert_date', 'updated'],
...
function table_comp_modulesets_nodes(divid, options) {
	var defaults = {
		...
		'span': ['node_id'],
		'spankeys': ['node_id'],
		'keys': ['node_id', 'modset_id'],
		'orderby': ['nodename', 'modset_name'],
		'force_cols': ['node_id', 'os_name', 'modset_id'],
		'columns': ['node_id', 'nodename', 'modset_id', 'modset_name', 'assetname', 'fqdn', 'serial', 'manufacturer', 'model', 'asset_env', 'role', 'status', 'type', 'sec_zone', 'tz', 'loc_country', 'loc_zip', 'loc_city', 'loc_addr', 'loc_building', 'loc_floor', 'loc_room', 'loc_rack', 'enclosure', 'enclosureslot', 'hvvdc', 'hvpool', 'hv', 'os_name', 'os_release', 'os_vendor', 'os_arch', 'os_kernel', 'cpu_dies', 'cpu_cores', 'cpu_threads', 'cpu_model', 'cpu_freq', 'mem_banks', 'mem_slots', 'mem_bytes', 'listener_port', 'version', 'action_type', 'collector', 'connect_to', 'node_env', 'team_responsible', 'team_integ', 'team_support', 'app', 'last_boot', 'last_comm', 'power_supply_nb', 'power_cabinet1', 'power_cabinet2', 'power_protect', 'power_protect_breaker', 'power_breaker1', 'power_breaker2', 'warranty_end', 'maintenance_end', 'os_obs_warn_date', 'os_obs_alert_date', 'hw_obs_warn_date', 'hw_obs_alert_date', 'updated'],
...
function table_comp_rulesets_services(divid, options) {
	defaults = {
		...
		'columns': ['svc_id', 'svcname', 'encap', 'ruleset_id', 'ruleset_name', 'svc_status', 'svc_availstatus', 'svc_app', 'svc_env', 'svc_ha', 'svc_topology', 'svc_flex_min_nodes', 'svc_flex_max_nodes', 'svc_flex_cpu_low_threshold', 'svc_flex_cpu_high_threshold', 'svc_drptype', 'svc_autostart', 'svc_nodes', 'svc_drpnode', 'svc_drpnodes', 'svc_comment', 'svc_created', 'svc_updated', 'svc_status_updated'],
...
function table_comp_modulesets_services(divid, options) {
	var defaults = {
		...
		'columns': ['svc_id', 'svcname', 'encap', 'modset_id', 'modset_name', 'svc_status', 'svc_availstatus', 'svc_app', 'svc_env', 'svc_ha', 'svc_topology', 'svc_flex_min_nodes', 'svc_flex_max_nodes', 'svc_flex_cpu_low_threshold', 'svc_flex_cpu_high_threshold', 'svc_drptype', 'svc_autostart', 'svc_nodes', 'svc_drpnode', 'svc_drpnodes', 'svc_comment', 'svc_created', 'svc_updated', 'svc_status_updated'],
...
function table_comp_rules(divid, options) {
	var defaults = {
		...
		'keys': ['ruleset_id', 'encap_rset_id'],
		'spankeys': ['ruleset_id', 'encap_rset_id'],
...
function table_dashboard(divid, options) {
	var defaults = {
		...
		'orderby': ['~dash_severity', 'dash_type', 'nodename', 'svcname', 'dash_instance'],
...
function table_disks(divid, options) {
	var defaults = {
		...
		'span': ['disk_id'],
		'spankeys': ['disk_id', 'disk_size', 'disk_alloc', 'disk_arrayid', 'disk_devid', 'disk_name', 'disk_raid', 'disk_group', 'array_model'],
		'keys': ['disk_id', 'disk_region', 'node_id', 'svc_id'],
...
function table_filtersets(divid, options) {
	var defaults = {
		...
		'spankeys': ['fset_name', 'fset_stats'],
		'keys': ['fset_id', 'f_id', 'encap_fset_id'],
...
function table_quota(divid, options) {
	var defaults = {
		...
		'spankeys': ['array_name', 'dg_name', 'app'],
		'keys': ['array_name', 'dg_name', 'app'],
...
function table_sanswitches(divid, options) {
	var defaults = {
		...
		'spankeys': ['sw_name', 'sw_index'],
		'keys': ['sw_name', 'sw_index'],
...
function table_saves(divid, options) {
	var defaults = {
		...
		'span': ['node_id', 'nodename', 'svc_id', 'svcname'],
		'spankeys': ['node_id', 'save_server', 'svc_id'],
...
function table_service_instances(divid, options) {
	var defaults = {
		...
		'force_cols': [
			...
			'mon_ipstatus',		// used in the overallstatus decorator
			'mon_fsstatus',		// used in the overallstatus decorator
			'mon_diskstatus',	// used in the overallstatus decorator
			'mon_sharestatus',	// used in the overallstatus decorator
			'mon_syncstatus',	// used in the overallstatus decorator
			'mon_appstatus',	// used in the overallstatus decorator
			'mon_hbstatus',		// used in the overallstatus decorator
			'mon_updated',
			'os_name',
		],
		'wsable': true,
...
function table_tagattach(divid, options) {
	var defaults = {
		...
		'spankeys': ['tag_id', 'node_id', 'svc_id'],
...
function table_workflows(divid, options) {
	var defaults = {
		...
		'span': ['form_head_id'],
		'spankeys': ['form_head_id'],
		'keys': ['form_head_id'],
		'orderby': ['~last_form_id'],
		'force_cols': ["form_head_id", "last_form_id"],
