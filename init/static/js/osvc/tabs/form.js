...
function form_tabs(divid, options) {
	...
	o._load = function() {
		...
		o.tabs[i].callback = function(divid) {
			form_revisions(divid, o.options)
		}
...
function form_revisions(divid, options) {
	var o = {}
	...
	o.load_form = function() {
		services_osvcgetrest("/forms/%1/revisions", [o.options.form_id], "", function(jd) {
			...
			require(["vis"], function(vis) {
				...
				o.revisions.on('click', function(e) {
					...
					services_osvcgetrest("/forms/%1/diff/%2", [o.options.form_id, props['item']], "", function(jd) {
						o.diff.html(jd)
	...
	o._load_form = function(data) {
		o.bt_rollback.on("click", function(e) {
                        services_osvcpostrest("/forms/%1/rollback/%2", [o.options.form_id, o.bt_rollback.data('cid')])
		})
	}
