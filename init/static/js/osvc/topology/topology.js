		...
		$.getJSON(url, o.options, function(_data){
			...
			var options = {
				...
				"groups": {
					...
					"hb": {"shape": "icon", "icon": {"face": "FontAwesome", "code": "\uf21e", "color": "seagreen", "size": 50}},
					"share": {"shape": "icon", "icon": {"face": "FontAwesome", "code": "\uf1e0", "color": "seagreen", "size": 50}},
					"stonith": {"shape": "icon", "icon": {"face": "FontAwesome", "code": "\uf1e2", "color": "seagreen", "size": 50}},
					"disk": {"shape": "icon", "icon": {"face": "FontAwesome", "code": "\uf1c0", "color": "seagreen", "size": 50}},
					"disk.scsireserv": {"shape": "icon", "icon": {"face": "FontAwesome", "code": "\uf023", "color": "seagreen", "size": 50}},
					...
					"ip": {"shape": "icon", "icon": {"face": "FontAwesome", "code": "\uf124", "color": "seagreen", "size": 50}},
					...
					"envs": {"shape": "icon", "icon": {"face": "FontAwesome", "code": "\uf24d", "color": "seagreen", "size": 100}},
					"resource": {"shape": "icon", "icon": {"face": "FontAwesome", "code": "\uf292", "color": "seagreen", "size": 50}},
					"svc": {"shape": "icon", "icon": {"face": "FontAwesome", "code": "\uf111", "color": "seagreen", "size": 50}}
				},
				clickToUse: true,
				height: _height+'px',
				nodes: {
