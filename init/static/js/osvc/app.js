...
function init_requirejs() {
	require.config({
		...
		paths: {
			...
			"jqplot-plugins-highlighter": "jqplot/plugins/jqplot.highlighter",
			"jqplot-plugins-canvasTextRenderer": "jqplot/plugins/jqplot.canvasTextRenderer",
			"jqplot-plugins-canvasAxisTickRenderer": "jqplot/plugins/jqplot.canvasAxisTickRenderer",
			"jqplot-plugins-categoryAxisRenderer": "jqplot/plugins/jqplot.categoryAxisRenderer",
			"jqplot-plugins-dateAxisRenderer": "jqplot/plugins/jqplot.dateAxisRenderer",
			"jqplot-plugins-barRenderer": "jqplot/plugins/jqplot.barRenderer",
			"jqplot-plugins-ohlcRenderer": "jqplot/plugins/jqplot.ohlcRenderer",
			"jqplot-plugins-cursor": "jqplot/plugins/jqplot.cursor",
			"jqplot-plugins-enhancedLegendRenderer": "jqplot/plugins/jqplot.enhancedLegendRenderer",
			"jqplot-plugins-pieRenderer": "jqplot/plugins/jqplot.pieRenderer",
			"jqplot-plugins-donutRenderer": "jqplot/plugins/jqplot.donutRenderer",
