...
module_actions = [
  {'title': 'Check', 'class': 'icon16 comp-c', 'action': 'check'},
  {'title': 'Fix', 'class': 'icon16 comp-c', 'action': 'fix'},
]

resource_actions = [
  {'title': 'Start', 'class': 'icon16 action_start_16', 'action': 'start'},
  {'title': 'Stop', 'class': 'icon16 action_stop_16', 'action': 'stop'},
  {'title': 'Restart', 'class': 'icon16 action_restart_16', 'action': 'restart'},
  {'title': 'Enable', 'class': 'icon16 ok', 'action': 'enable'},
  {'title': 'Disable', 'class': 'icon16 nok', 'action': 'disable'},
]
...
svc_actions = [
  ...
  {'title': 'Stop', 'class': 'icon16 action_stop_16', 'action': 'stop'},
  {'title': 'Restart', 'class': 'icon16 action_restart_16', 'action': 'restart'},
  {'title': 'Switch', 'class': 'icon16 action_switch_16', 'action': 'switch'},
  {'title': 'Sync all remotes', 'class': 'icon16 action_sync_16', 'action': 'syncall'},
  {'title': 'Sync peer remotes', 'class': 'icon16 action_sync_16', 'action': 'syncnodes'},
  {'title': 'Sync disaster recovery remotes', 'class': 'icon16 action_sync_16', 'action': 'syncdrp'},
  {'title': 'Enable', 'class': 'icon16 ok', 'action': 'enable'},
  {'title': 'Disable', 'class': 'icon16 nok', 'action': 'disable'},
  {'title': 'Thaw', 'class': 'icon16 ok', 'action': 'thaw'},
  {'title': 'Freeze', 'class': 'icon16 nok', 'action': 'freeze'},
  {'title': 'Compliance check', 'class': 'icon16 comp-c', 'action': 'compliance_check', 'params': ["module", "moduleset"]},
  {'title': 'Compliance fix', 'class': 'icon16 comp-c', 'action': 'compliance_fix', 'params': ["module", "moduleset"]},
]

node_actions = [
  {'title': 'Update node information', 'class': 'icon16 node16', 'action': 'pushasset'},
  {'title': 'Update disks information', 'class': 'icon16 hd16', 'action': 'pushdisks'},
  {'title': 'Update app information', 'class': 'icon16 svc-c', 'action': 'push_appinfo'},
  {'title': 'Update services information', 'class': 'icon16 svc-c', 'action': 'pushservices'},
  {'title': 'Update installed packages information', 'class': 'icon16 pkg16', 'action': 'pushpkg'},
  {'title': 'Update installed patches information', 'class': 'icon16 pkg16', 'action': 'pushpatch'},
  {'title': 'Update stats', 'class': 'icon16 spark16', 'action': 'pushstats'},
  {'title': 'Update check values', 'class': 'icon16 ok', 'action': 'checks'},
  {'title': 'Update sysreport', 'class': 'icon16 log16', 'action': 'sysreport'},
  {'title': 'Update compliance modules', 'class': 'icon16 comp-c', 'action': 'updatecomp'},
  {'title': 'Update opensvc agent', 'class': 'icon16 pkg16', 'action': 'updatepkg'},
  {'title': 'Rotate root password', 'class': 'icon16 key', 'action': 'rotate root pw'},
  {'title': 'Rescan scsi hosts', 'class': 'icon16 hd16', 'action': 'scanscsi'},
  {'title': 'Reboot', 'class': 'icon16 action_restart_16', 'action': 'reboot'},
  {'title': 'Reboot schedule', 'class': 'icon16 action_restart_16', 'action': 'schedule_reboot'},
  {'title': 'Reboot unschedule', 'class': 'icon16 action_restart_16', 'action': 'unschedule_reboot'},
  {'title': 'Shutdown', 'class': 'icon16 action_stop_16', 'action': 'shutdown'},
  {'title': 'Wake On LAN', 'class': 'icon16 action_start_16', 'action': 'wol'},
  {'title': 'Compliance check', 'class': 'icon16 comp-c', 'action': 'compliance_check', 'params': ["module", "moduleset"]},
  {'title': 'Compliance fix', 'class': 'icon16 comp-c', 'action': 'compliance_fix', 'params': ["module", "moduleset"]},
]
