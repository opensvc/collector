...
menu_entries_data = {
  ...
  'view-services': DIV(T('Services'), DIV(T("Service instances status")), _class='svc48'),
  ...
  [DIV(T('Navigation'), _class="menu16"), False, '',
    ...
    [T('Views'), False, '',
         [
             ...
             [menu_entries_data['view-services'], display('view-services'), URL(request.application,'default','svcmon')],
